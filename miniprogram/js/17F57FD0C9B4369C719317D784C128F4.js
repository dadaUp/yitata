...
showdown.helper.matchRecursiveRegExp = function(e, r, n, t) {
    ...
    function i(e, r) {
        ...
        return e = (e = e.replace(/(\n)?(^[ \t]*)([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(~0|\2([*+-]|\d+[.])[ \t]+))/gm, function(e, r, n, t, o, s, a) {
            ...
            showdown.subParser("blockGamut")(i, h, d)) : (i = (i = showdown.subParser("lists")(i, h, d)).replace(/\n$/, ""), 
            c ? showdown.subParser("paragraphs")(i, h, d) : showdown.subParser("spanGamut")(i, h, d))) + "</li>\n";
    ...
    var r = /^(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm;
    return e = (e = d.gListLevel ? e.replace(r, function(e, r, n) {
        return o(r, -1 < n.search(/[*+-]/g) ? "ul" : "ol", !0);
    }) : (r = /(\n\n|^\n?)(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, 
    e.replace(r, function(e, r, n, t) {
        return o(n, -1 < t.search(/[*+-]/g) ? "ul" : "ol");
    }))).replace(/~0/, ""), e = d.converter._dispatch("lists.after", e, h, d);
